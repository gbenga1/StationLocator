 ...
 * triggered the event.
 */
public class ForteReceiveTransitionsService extends IntentService {
	private final String TAG = "ForteReceiveTransitionsService";

	/**
	 * Sets an identifier for this class' background thread
	 */
	public ForteReceiveTransitionsService() {
		super("ForteReceiveTransitionsService");
	}
	...
	protected void onHandleIntent(Intent intent) {
		...
		broadcastIntent.addCategory(ForteConstants.CATEGORY_LOCATION_SERVICES);
		...
		if (LocationClient.hasError(intent)) {
			...
			String errorMessage = ForteLocationServiceErrorMessages
			...
			broadcastIntent.setAction(ForteConstants.ACTION_GEOFENCE_ERROR)
					.putExtra(ForteConstants.EXTRA_GEOFENCE_STATUS,
							errorMessage);
			...
			if ((transition == Geofence.GEOFENCE_TRANSITION_ENTER)
				...
				String ids = TextUtils.join(
						ForteConstants.GEOFENCE_ID_DELIMITER, geofenceIds);
